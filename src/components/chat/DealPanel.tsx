...
interface DealPanelProps {
  ...
  quantityStarting: boolean;
  quantityActing: boolean;
  onStartQuantityDeal: (mode: NegotiationMode) => void;
  onContinueQuantityDeal: () => void;
  onAcceptQuantityDeal: () => void;
...
export function DealPanel({
  ...
  quantityActing,
  onStartQuantityDeal,
  onContinueQuantityDeal,
  onAcceptQuantityDeal,
  onTryAnotherSeller,
}: DealPanelProps) {
    ...
    <aside className="flex h-full flex-col gap-5 overflow-y-auto border-border bg-surface p-4 sm:p-5 lg:border-l">
      ...
      {deal && dealProduct ? (
        <QuantityDealPanel
          ...
          starting={quantityStarting}
          acting={quantityActing}
          onStart={onStartQuantityDeal}
          onContinue={onContinueQuantityDeal}
          onAccept={onAcceptQuantityDeal}
          onTryAnotherSeller={onTryAnotherSeller}
        />
      ) : null}
